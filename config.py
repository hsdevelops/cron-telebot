...
help_message = "I can help you schedule recurring messages using <a href='https://crontab.guru/'>cron schedule expressions</a>.\n\n<b>Available commands</b>\n/add - add a new job\n/list - list running jobs\n/delete - delete a job\n\n<b>Found a bug?</b>\nPlease contact the bot owner at hs.develops.1@gmail.com."  # html
...
request_crontab_message = "Give me your cron schedule expression (e.g. 4 5 * * *), click <a href='https://crontab.guru/'>here</a> if you need help.\n\n(swipe left to reply to this message)"  # html
...
USER_DATA_SHEETNAME = (
    "user data"  # depends on what you name your sheet, defaults to Sheet1.
)
