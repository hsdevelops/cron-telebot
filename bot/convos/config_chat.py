...
# state 1
async def update_sender(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
def reset_sender(db_service, chat_id: str, user_id: str, new_token: Optional[str], prev_token: Optional[str] = None):
