...
def handle_photos(update, context):
    ...
    if reply_to_message is None:
        return
    if reply_to_message.text == replies.request_text_message:
        actions.add_message(update, True)
